...
<body>
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins" style="padding-top: 100px">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
              
                <div class="card-body">
                    <h2 class="title" style="text-align: center">Sign In</h2>
                    <form method="POST" action="proc/login_proc.php">
                        ...
                        <div class="p-t-10" style="text-align: center">
                            <button  class="btn btn--pill btn--green" type="submit" name="submit">Login</button>
                        </div>
                    </form>
                </div>
            </div>
